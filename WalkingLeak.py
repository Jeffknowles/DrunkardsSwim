...
class SubplotAnimation(animation.TimedAnimation):
    def __init__(self):
        ...
        ax2.text(0.01, 0.8, str(current) + ' cm/s', fontsize=18, transform=ax2.transAxes)
        ax2.text(0.01, 0.05, '0 cm/s', fontsize=18, transform=ax2.transAxes)
        ax3.text(0.01, 0.8, 'threshold',fontsize=18, transform=ax3.transAxes)
        ax3.text(0.01, 0.08, 'baseline', fontsize=18, transform=ax3.transAxes)
        ...
        #ax2.set_title('current speed (cm/s)')
        #ax2.set_aspect('equal')
        #ax3.set_title('lateral line integrator')
